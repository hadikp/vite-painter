...
<template>
  <div class="about">
    <h1 class="p-3 mb-2 bg-warning text-dark">This is a Firebase page</h1>
  </div>
  <button @click="readData">Create User</button>
  <!-- <button @click="readData">Create country</button>  createCountry -->
  ...
  <!-- <button @click="readData">Delete User</button> dropUser -->
</template>
<style scoped>
</style>